...
local customHWID = "custom0-2804-jpa1-nobita0123"
...
if currentKey ~= VALID_KEY then
    task.defer(function() player:Kick("👉FuckYou👍") end)
    return
end
